...
DATABASES = {
    'default': dj_database_url.config(
        default=os.environ.get('postgresql://neondb_owner:npg_XygCNnm1j0dx@ep-holy-dream-aptxm0k5-pooler.c-7.us-east-1.aws.neon.tech/neondb?sslmode=require&channel_binding=require')
    )
}
